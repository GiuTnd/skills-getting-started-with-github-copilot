...
activities = {
    ...
    "Swimming Club": {
        "description": "Laps, technique training, and local meets",
    ...
    "Drama Club": {
        "description": "Acting exercises, script work, and school performances",
    ...
    "Debate Team": {
        "description": "Practice public speaking, argumentation, and local debates",
